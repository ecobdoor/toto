...
///
	 ...
	 * https://fr.wikipedia.org/wiki/Exposants_et_indices_Unicode
	 ...
	 X⁰ⁱ⁴X²X³X¹̃X̃ U0303 combinig tilde ã '⊹ X⃔ X̂ v᷋ Z̄vZ̅Y̲
	 */
...
// CF. https://unicode-table.com/fr/sets/arrow-symbols/#heavy-arrows
	...
	_SERIAL_0(
		"\nLook correct:{X⁰ⁱ⁴X²X³X¹̃X̃ U0303 combinig tilde ã '⊹ X⃔ X̂ v᷋ Z̄Z̅Y̲f̲⍄⍃ᐊᐅ☚☛⇚⇛⥢⥤⟿⤳➥🇼⟰⟱⚺ƧɅ±∇¤øƟɅɣʬΔΛϪᴓᴧᵛ†‼⁞G⁞∥Ñ∥∆∩⌂▬►◄◊¥Vv□ΥѲ˅˄▲▼ꜛꜜ◊↑↓↕↨ˠØ}");
	_SERIAL_0("\nSeem hazard: {🢠🢡⯬⯮⮄⮆⮰⮳⬳⬿⓿⮛Ⓐ⮟⮝⮊🠼🡂⮨⮫⑬⓹}");
	_SERIAL_0("\nSeem strange:{߇߈}");
	_SERIAL_0("\n********************\x24\x60***********************");
