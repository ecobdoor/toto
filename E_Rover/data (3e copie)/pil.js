...
function _Canvas2DUmi(CANVAS, XMIN, XORG, XMAX, YMIN, YORG, YMAX, LFT, RGT, TOP, BOT,
	...
	this.Init2D = function() {
		...
		*/
		...
		//		this._CTX.translate(-col(0), -row(0));
...
function Start() {
	...
	*/
	...
	/*
		AREAS["CENTER"] = document.getElementById("CENTER");
		AREAS["FOOT"] = document.getElementById("FOOT");
		AREAS["HEAD"] = document.getElementById("HEAD");
		AREAS["LEFT"] = document.getElementById("LEFT");
		AREAS["RIGHT"] = document.getElementById("RIGHT");
		VIEWS["MOTORS"] = document.getElementById("MOTORS");
		VIEWS["MAP"] = document.getElementById("MAP");
		VIEWS["ATTITUDE"] = document.getElementById("ATTITUDE");
	*/
