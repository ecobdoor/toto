...
let cameras, scene, renderer, cameraControls, _Ground, _Rover;
cameras =new Array();
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
/*
...
//=====================================================================
/*
	function _tickLine(WORLD,XA,YA,ZA,XB,YB,ZB,COLOR,RADIUS)
*/
function _tickLine( XA, YA, ZA, XB, YB, ZB, COLOR, RADIUS) {
    var Elts= new Array();
	// Material
	const material = new THREE.LineBasicMaterial({ color: COLOR });
...
function Frame(WORLD, X, Y, Z, LEN) {
    var Elts= new Array();
	Elts[]=new _segment(WORLD, X, Y, Z, X + LEN, Y, Z, 0xff0000);
	Elts[]=new _segment(WORLD, X, Y, Z, X, Y + LEN, Z, 0x00ff00);
	Elts[]=new _segment(WORLD, X, Y, Z, X, Y, Z + LEN, 0x0000ff);
    return Elts
}
//=====================================================================
/*
...
function Box( Xmin, Ymin, Zmin, Xmax, Ymax, Zmax) {
	...
	*/
	Elts[]=new _tickLine('iX+', 0, 0, 0, Xmax, 0, 0, _Xmax_Color, 2);
	Elts[]=new _tickLine('jY+', 0, 0, 0, 0, Ymax, 0, _Ymax_Color, 2);
	Elts[]=new _tickLine('kZ+', 0, 0, 0, 0, 0, Zmax, _Zmax_Color, 2);

	Elts[]=new _tickLine('iX-', Xmin, 0, 0, 0, 0, 0, _Xmin_Color, 2);
	Elts[]=new _tickLine('jY-', 0, Ymin, 0, 0, 0, 0, _Ymin_Color, 2);
	Elts[]=new _tickLine('kZ-', 0, 0, Zmin, 0, 0, 0, _Zmin_Color, 2);


	// walls         

	Elts[]=new wall("wX+",  0.1 + Zmax - Zmin, 0.1 + Ymax - Ymin,
		Xmax,
		(Ymax + Ymin) / 2,
		(Zmax + Zmin) / 2,
		0,
	...
	*/
	Elts[]=new wall("wY+", WORLD, 0.1 + Xmax - Xmin, 0.1 + Zmax - Zmin,
		(Xmax + Xmin) / 2,
		Ymax,
		(Zmax + Zmin) / 2,
		- Math.PI / 2,
	...
	*/
	//        DEBUG=true;
	Elts[]=new wall("wZ+", WORLD, 0.1 + Xmax - Xmin, 0.1 + Ymax - Ymin,
		(Xmax + Xmin) / 2,
		(Ymax + Ymin) / 2,
		Zmax,
		0,
