...
function workFiles() {
	...
	xhttp.open("GET", "workFiles", false);// false is synchrone !!!
	/*
...
function Start() {
	...
	_WSROV = new Slot_socket(MODULES, "wsR",
		...
		new SocketCLI("rover", "ws://" + window.location.host + ":" + allCFG.roverPORT + "/ws", DEF_QUERY_PILOT_TO_ROVER),
		allCFG.BamountTMS);
	...
	*/
	...
	_JOBGOAL = new Slot_jobgoal(MODULES, "JOB",
		...
		new __select("sel_WORKJOB", "divExe_WORKJOB", 'IDchooseWorkjob', "JOB", jsonFiles),
		new __select("classTimer", 'divTim_JOBGOAL', "IDtim_JOBGOAL", "JOB", CFG.client.__field_timer),
		new __text("IOworkjob", 'IOworkjob_container', "IOworkjob", CFG.client.__field_txt),
		JOY_STICK, CANVAS_PILOT, CANVAS_MOTORS, _WSROV, _WSBAS);
