# ESP32-CAM motion SMS & FTP

This project runs on ESP32-CAM and extends functionalities of Eloquent project following 5 axis:

  * Delivers an enhanced html interface for motion parameters access
  * Defines templates to run the same code for 1, 2, 3 bytes pixels format (gray, rgb565 & rgb888)
  * Implements graphics utilities (font & figures drawing...)
  * Alerts via SMS when motion is detected and upload images to FTP server in BMP format
  * Load configuration (motion parameters, security certificate...) from SD card
  * Supports OTA update
  
![Texte alternatif](/media/DEV/ROB_000/rover/CameraWebServer_999/motionSmsFtp_000.png)
