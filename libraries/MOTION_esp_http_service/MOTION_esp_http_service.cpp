...
void start_MOTION_webservices(httpd_handle_t server_httpd, httpd_handle_t stream_httpd){
	...
	Serial.printf("\n%7x index_uri", httpd_register_uri_handler(server_httpd, &index_uri));
	Serial.printf("\n%7x cmd_uri", httpd_register_uri_handler(server_httpd, &cmd_uri));
	Serial.printf("\n%7x status_uri", httpd_register_uri_handler(server_httpd, &status_uri));
	Serial.printf("\n%7x capture_uri", httpd_register_uri_handler(server_httpd, &capture_uri));

	Serial.printf("\n%7x stream_uri",httpd_register_uri_handler(stream_httpd, &stream_uri));
}
///////////////////////////////////////////////////////////////////////
